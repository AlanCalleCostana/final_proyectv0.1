              ...
              <tbody>
                ...
                foreach ($usuario->result() as $row) {
                  ...
                  <tr>
                    ...
                    <td>
                      <?php
                      echo form_open_multipart("pageAdmin/modificaruser");
                      ?>
                      <input type="hidden" name="iduser" value="<?php echo $row->idusuario; ?>">
                    ...
                    <td>
                    <?php
                      echo form_open_multipart("pageAdmin/eliminaruserbd");
                      ?>
                      <input type="hidden" name="iduser" value="<?php echo $row->idusuario; ?>">
